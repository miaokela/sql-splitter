...
SqlLoader.SQL_FILE_PATH = (
    "/Users/kela/Program/open-sources/sql-splitter/sql_splitter/example/sql"
)
loader = SqlLoader()
...
sql = loader.get("user.index.query_user_info", options={"user_id": 2})
